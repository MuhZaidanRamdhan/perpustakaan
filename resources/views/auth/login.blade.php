    ...
    <div class="min-h-screen flex items-center justify-center px-4 bg-gray-100">
        ...
        <div
            ...
            <div class="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center">
                ...
                <div class="mb-8">
                    <h3 class="text-2xl font-bold text-gray-800">Login ke Akun</h3>
                    <p class="text-gray-500 text-sm">
                        Masukkan email dan password kamu untuk akses dashboard.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" type="password" name="password" placeholder="••••••••"
                                class="w-full mt-1 px-4 py-3 rounded-xl border border-gray-300 bg-white
                                       focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition outline-none pr-12"
                                required>
